  ...
  {:else if post}
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div class="lg:col-span-2 space-y-4">
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-4 space-y-4">
          <div class="space-y-1">
            <label for="editBlocks" class="form-label"
              >Content (HTML or EditorJS JSON)</label
            >
            <textarea
              id="editBlocks"
            ...
            <p class="text-xs text-gray-500 mt-1">
              For advanced editing, use the Merchant Portal.
            </p>
          </div>
        </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-4 space-y-4">
          ...
          <Input
            name="editSeoTitle"
            label="SEO Title"
            bind:value={editSeoTitle}
            placeholder="Optional override"
          />

          <div class="space-y-1">
            <label for="editSeoDescription" class="form-label"
      ...
      <div class="space-y-4">
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-4 space-y-4">
          ...
          {#if post.featuredImage}
            <div
              class="relative aspect-video rounded-lg overflow-hidden bg-gray-100 mb-2"
            >
              <img
