                ...
                <thead>
                  <tr class="border-b border-gray-200">
                    <th class="text-left py-2 font-medium text-gray-600"
                      >Description</th
                    >
                    <th class="text-right py-2 font-medium text-gray-600 w-20"
                      >Qty</th
                    >
                    <th class="text-right py-2 font-medium text-gray-600 w-28"
                      >Unit Price</th
                    >
                    <th class="text-right py-2 font-medium text-gray-600 w-28"
                      >Total</th
                ...
                <tbody>
                  {#each invoice.lineItems as item (item.id)}
                    <tr class="border-b border-gray-50">
                      ...
                      <td class="py-2.5 text-right text-gray-700 tabular-nums"
                        >{item.quantity}</td
                      >
                      <td class="py-2.5 text-right text-gray-700 tabular-nums"
                        >{formatCurrency(amt(item.unitPrice))}</td
                      >
                      <td
                        class="py-2.5 text-right font-medium text-gray-900 tabular-nums"
                        >{formatCurrency(amt(item.total))}</td
                      >
                    </tr>
                  {/each}
                </tbody>
